    ...
    >
      ...
      <div className="flex justify-between flex-wrap gap-4">
        ...
        <div className="flex flex-col gap-2 w-full md:w-1/4">
          <label className="text-sm text-gray-600 font-semibold">Sex</label>
          <select
            className="ring-[1.5px] ring-gray-300 p-3 rounded-md text-sm bg-gray-50 hover:bg-gray-100 transition-colors duration-300"
            {...register("sex")}
        ...
        <div className="flex flex-col gap-2 w-full md:w-1/4 justify-center">
          <label
            className="text-sm text-gray-600 font-semibold flex items-center gap-2 cursor-pointer"
            htmlFor="img"
          >
